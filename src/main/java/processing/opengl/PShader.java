...
public class PShader implements PConstants {
   ...
   */
  public PShader(PGraphicsOpenGL pg, String vertFilename, String fragFilename) {
    primaryPG = pg;
    pgl = primaryPG.pgl;
   ...
   */
  public PShader(PGraphicsOpenGL pg, URL vertURL, URL fragURL) {
    primaryPG = pg;
    pgl = primaryPG.pgl;
  ...
  public PShader(PGraphicsOpenGL pg, String[] vertSource, String[] fragSource) {
    primaryPG = pg;
    pgl = primaryPG.pgl;
