...
package processing.opengl.glu.error;

import processing.opengl.glu.Glue;
...
public class Error {
  ...
  public static String gluErrorString( final int errorCode ) {
    ...
    if( (errorCode >= GL_INVALID_ENUM) && (errorCode <= GL_INVALID_FRAMEBUFFER_OPERATION) ) {
      return( glErrorStrings[ errorCode - GL_INVALID_ENUM ] );
    }
    if( errorCode == 0x8031 /* GL_TABLE_TOO_LARGE */ ) {
