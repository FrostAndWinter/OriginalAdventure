...
class PriorityQHeap extends processing.opengl.glu.tessellator.PriorityQ {
    processing.opengl.glu.tessellator.PriorityQ.PQnode[] nodes;
    processing.opengl.glu.tessellator.PriorityQ.PQhandleElem[] handles;
    int size, max;
    int freeList;
    boolean initialized;
    processing.opengl.glu.tessellator.PriorityQ.Leq leq;

/* really __gl_pqHeapNewPriorityQ */
    public PriorityQHeap(final processing.opengl.glu.tessellator.PriorityQ.Leq leq) {
        size = 0;
        max = processing.opengl.glu.tessellator.PriorityQ.INIT_SIZE;
        nodes = new processing.opengl.glu.tessellator.PriorityQ.PQnode[processing.opengl.glu.tessellator.PriorityQ.INIT_SIZE + 1];
        for (int i = 0; i < nodes.length; i++) {
            nodes[i] = new PQnode();
        }
        handles = new processing.opengl.glu.tessellator.PriorityQ.PQhandleElem[processing.opengl.glu.tessellator.PriorityQ.INIT_SIZE + 1];
...
/* really __gl_pqHeapDeletePriorityQ */
    ...
    void FloatDown(int curr) {
        final processing.opengl.glu.tessellator.PriorityQ.PQnode[] n = nodes;
        final processing.opengl.glu.tessellator.PriorityQ.PQhandleElem[] h = handles;
        int hCurr, hChild;
        int child;
...
/* returns LONG_MAX iff out of memory */
    ...
    int pqInsert(final Object keyNew) {
        ...
        curr = ++size;
        if ((curr * 2) > max) {
            final processing.opengl.glu.tessellator.PriorityQ.PQnode[] saveNodes = nodes;
            final processing.opengl.glu.tessellator.PriorityQ.PQhandleElem[] saveHandles = handles;
