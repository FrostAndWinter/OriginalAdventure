...
class PriorityQSort extends processing.opengl.glu.tessellator.PriorityQ {
    processing.opengl.glu.tessellator.PriorityQHeap heap;
    Object[] keys;
    ...
    public PriorityQSort(final processing.opengl.glu.tessellator.PriorityQ.Leq leq) {
        heap = new processing.opengl.glu.tessellator.PriorityQHeap(leq);

        keys = new Object[processing.opengl.glu.tessellator.PriorityQ.INIT_SIZE];
...
/* really __gl_pqSortDeletePriorityQ */
    ...
    private static boolean LT(final processing.opengl.glu.tessellator.PriorityQ.Leq leq, final Object x, final Object y) {
        return (!PriorityQ.LEQ(leq, y, x));
    }

    private static boolean GT(final processing.opengl.glu.tessellator.PriorityQ.Leq leq, final Object x, final Object y) {
