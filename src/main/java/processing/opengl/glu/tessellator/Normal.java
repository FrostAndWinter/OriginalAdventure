 ...
 */
    ...
    static void ComputeNormal(final GLUtessellatorImpl tess, final double[] norm) {
        processing.opengl.glu.tessellator.GLUvertex v, v1, v2;
        double c, tLen2, maxLen2;
        double[] maxVal, minVal, d1, d2, tNorm;
        processing.opengl.glu.tessellator.GLUvertex[] maxVert, minVert;
        final processing.opengl.glu.tessellator.GLUvertex vHead = tess.mesh.vHead;
        int i;

        maxVal = new double[3];
        minVal = new double[3];
        minVert = new processing.opengl.glu.tessellator.GLUvertex[3];
        maxVert = new processing.opengl.glu.tessellator.GLUvertex[3];
        d1 = new double[3];
        d2 = new double[3];
        tNorm = new double[3];
...
/* All points lie on a single line -- any decent normal will do */
    ...
    static void CheckOrientation(final GLUtessellatorImpl tess) {
        ...
        final processing.opengl.glu.tessellator.GLUface fHead = tess.mesh.fHead;
