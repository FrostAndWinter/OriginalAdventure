...
class GLUhalfEdge {
    ...
    public processing.opengl.glu.tessellator.GLUface Lface;        /* left face */

    /* Internal data (keep hidden) */
    public processing.opengl.glu.tessellator.ActiveRegion activeRegion;    /* a region with this upper edge (sweep.c) */
