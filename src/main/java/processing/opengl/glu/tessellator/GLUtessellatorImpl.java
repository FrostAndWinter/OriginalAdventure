...
//    private static final int GLU_TESS_MESH = 100112;    /* void (*)(GLUmesh *mesh)        */
    private static GLUtessellatorCallback NULL_CB = new GLUtessellatorCallback() {
    @Override
    public void begin(final int var1) {
    ...
    @Override
    public void vertex(final Object var1) {
    ...
    @Override
    public void combine(final double[] var1, final Object[] var2, final float[] var3, final Object[] var4) {
    ...
    @Override
    public void error(final int var1) {
...
//        callMesh = NULL_CB;
    ...
    static public GLUtessellatorImpl gluNewTess()
    {
 ...
 * in the ordering arou nd the left face.
 */
